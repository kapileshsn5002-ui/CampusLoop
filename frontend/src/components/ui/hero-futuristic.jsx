...
import { Sparkles, ArrowDown, CalendarPlus, ShieldCheck } from "lucide-react";
...
export const HeroFuturistic = ({
  ...
  // Interactive Particle Grid & Scan Beam Canvas Animation
  useEffect(() => {
    ...
    // Create 3D particle mesh points
  ...
  return (
    ...
    >
      ...
      {/* AMBIENT GLOW BACKDROP FALLBACK */}
      <div
        style={{
          position: "absolute",
          top: "-30%",
