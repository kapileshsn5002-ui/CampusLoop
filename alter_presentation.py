...
def build_altered_deck():
    ...
    # Colors
    BLACK_TEXT = RGBColor(15, 23, 42)      # #0F172A Deep Dark Slate / Black (100% visible)
    NAVY_TITLE = RGBColor(30, 58, 138)    # #1E3A8A Deep Royal Blue
    ACCENT_BLUE = RGBColor(37, 99, 235)   # #2563EB Bright Blue
    MUTED_TEXT = RGBColor(71, 85, 105)    # #475569 Dark Muted Slate

    SLATE_BG = RGBColor(248, 250, 252)    # #F8FAFC Light Background
    WHITE_BG = RGBColor(255, 255, 255)    # #FFFFFF Card Background
    CARD_BORDER = RGBColor(148, 163, 184) # #94A3B8 Strong Dark Border

    BLUE_BOX_BG = RGBColor(219, 234, 254)  # #DBEAFE Light Blue Fill
    BLUE_BOX_BORDER = RGBColor(37, 99, 235)# #2563EB Blue Border
    ...
    def add_card(slide, left, top, width, height, bg_color=WHITE_BG, border_color=CARD_BORDER):
    ...
    # -------------------------------------------------------------
    # SLIDE 1 — TITLE (Using Kapilesh's details)
    # -------------------------------------------------------------
    ...
    # Academic Badge Box
    add_card(s1, Inches(0.8), Inches(0.8), Inches(4.5), Inches(0.45), BLUE_BOX_BG, BLUE_BOX_BORDER)
    tb_b = s1.shapes.add_textbox(Inches(0.9), Inches(0.85), Inches(4.3), Inches(0.35))
    p = tb_b.text_frame.paragraphs[0]
    p.alignment = PP_ALIGN.CENTER
    p.text = "ACADEMIC PROJECT PRESENTATION (2023-2027)"
    p.font.name = "Calibri"
    p.font.size = Pt(11)
    p.font.bold = True
    ...
    # Tech Stack Box
    add_card(s1, Inches(0.8), Inches(3.7), Inches(7.2), Inches(0.6), BLUE_BOX_BG, BLUE_BOX_BORDER)
    tb_tech = s1.shapes.add_textbox(Inches(0.9), Inches(3.75), Inches(7.0), Inches(0.5))
    ...
    add_card(s1, Inches(8.4), Inches(0.8), Inches(4.1), Inches(5.8), WHITE_BG, CARD_BORDER)
    ...
    student_data = [
        ("Student Name:", "Kapilesh Saami Nagesh"),
        ("Register Number:", "RA2311003050255"),
        ("Department:", "CSE CORE"),
    ...
    for step in wf_steps:
        add_card(s3, Inches(7.9), Inches(y_pos), Inches(4.3), Inches(0.45), BLUE_BOX_BG, BLUE_BOX_BORDER)
        tb_step = s3.shapes.add_textbox(Inches(8.0), Inches(y_pos + 0.05), Inches(4.1), Inches(0.35))
        p = tb_step.text_frame.paragraphs[0]
        p.alignment = PP_ALIGN.CENTER
        p.text = step
        p.font.name = "Calibri"
        p.font.size = Pt(12)
    ...
    add_card(s10, Inches(0.8), Inches(6.0), Inches(11.7), Inches(0.9), NAVY_TITLE, NAVY_TITLE)
    ...
    target_paths = [
        r"C:\Users\kapil\Downloads\CampusLoop_Presentation kapilesh (2).pptx",
        r"c:\Users\kapil\OneDrive\Desktop\Campus Loop\CampusLoop_Presentation.pptx"
    ]
